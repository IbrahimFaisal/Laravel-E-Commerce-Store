                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img width="80px" src="{{ $pdt->model->avatar }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                </a>
                                                <div class="cart-product-content">
                                                    <h5 class="cart-product-title">{{ $pdt->name }}
                                                    </h5>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="product-quantity">
                                            ...
                                            <div class="quantity">
                                                <a href="{{ route('cart.dec', [$pdt->rowId, $pdt->qty]) }}" class="quantity-minus">-</a>
                                                <input title="Qty" name="qty" value="{{ $pdt->qty }}" class="email input-text qty text" type="text" placeholder="1" readonly>
                                                <a href="{{ route('cart.inc', [$pdt->rowId, $pdt->qty]) }}" class="quantity-plus">+</a>
                                            </div>

                                        </td>

                                        <td class="product-subtotal">
                                            <h5 class="total amount">${{ $pdt->subtotal() }}</h5>
                                        </td>
                        ...
                        <div class="cart-total">
                            ...
                            <a href="{{ route('cart.checkout.index') }}" class="btn btn-medium btn--light-green btn-hover-shadow">
